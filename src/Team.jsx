...
// We can now hardcode the team with exact names and the .png avatar trick!
const TEAM_MEMBERS = [
  {
    login: 'ishan8351',
    name: 'Ishan Gupta',
    avatar_url: 'https://github.com/ishan8351.png',
    html_url: 'https://github.com/ishan8351',
  },
  {
    login: 'DarkWarrior411',
    name: 'Kumar Aadarsh',
    avatar_url: 'https://github.com/DarkWarrior411.png',
    html_url: 'https://github.com/DarkWarrior411',
  },
  {
    login: 'shashankmp2004',
    name: 'Shashank Padanad',
    avatar_url: 'https://github.com/shashankmp2004.png',
    html_url: 'https://github.com/shashankmp2004',
  },
  {
    login: 'Anandprafull',
    name: 'Prafull Anand',
    avatar_url: 'https://github.com/Anandprafull.png',
        ...
        {TEAM_MEMBERS.map((member, idx) => (
          ...
          >
            <div className="w-full sm:w-[280px] h-full bg-white border border-slate-200 rounded-3xl p-8 text-center hover:border-blue-300 transition-all duration-300 group relative overflow-hidden shadow-sm hover:shadow-[0_10px_40px_rgba(37,99,235,0.08)] hover:-translate-y-2">
              ...
              {/* The line-clamp-1 class ensures long names (like Kumar Aadarsh) truncate nicely with an ellipsis if needed */}
